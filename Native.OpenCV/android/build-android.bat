...
for %%A in (!ABIS!) do (
    ...
    REM 运行 CMake
    cmake .. -DCMAKE_TOOLCHAIN_FILE="!ANDROID_NDK!\build\cmake\android.toolchain.cmake" -DANDROID_ABI=%%A -DANDROID_PLATFORM=android-!MIN_SDK_VERSION! -DANDROID_STL=c++_shared -DOPENCV_ANDROID_SDK="!OPENCV_ANDROID_SDK!" -DCMAKE_BUILD_TYPE=Release -G "Ninja"
